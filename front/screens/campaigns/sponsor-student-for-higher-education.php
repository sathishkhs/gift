            ...
            <div class="col-xl-4 col-lg-4 p-4">
                ...
                <div class="feature-one__single feature-one__single-3">
                    ...
                    <div class="feature-one__content">
                        ...
                        <h3 class="text-dark mb-0">1,651</h3>
                        <p class="text-dark">students applied for scholarship</p>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 p-4">
                ...
                <div class="feature-one__single feature-one__single-3">
                    ...
                    <div class="feature-one__content">
                        <h3 class="text-dark mb-0">901</h3>
                        <p class="text-dark">students received scholarship</p>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 bg-logo-blue p-4">
                <!--Feature One Single-->
                <div class="feature-one__single feature-one__single-3 ">
                    <div class="feature-one__icon w-25 mr-20">
                        <span class="">
                    ...
                    <div class="feature-one__content">
                        <h3 class="text-dark mb-0">750</h3>
                        <p class="text-dark">students are waiting for scholarship</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-12">
                <div class="section-title text-center">
                    ...
                    <p class="mt-40">Barack Obama, the 44th President of the United States of America rightly said, “Higher education cannot be a luxury reserved just for a privileged few. It is an
                        economic necessity for every family. And every family should be able to afford it.” And we have witnessed it closely!</p>
        ...
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="contact-page__left">
                    ...
                    <div class="contact-page__contact-info">
                        ...
                        <p>Education has the power to eliminate several socio-economic issues. That’s
                            why time and again, education has received much attention with regards
                            to its quality, availability, and accessibility. Not just government, local and
                            global organisations are also striving to ensure ‘education for all’ at various
                            levels. </p>

                        <!-- <h4 class="section-title__tagline"> Join our Each 1 Educate 1 campaign.</h4> -->

                        <p class="thm-text">Completing higher education instils self-confidence, broadens
                            perspectives, and empowers youth with necessary knowledge and skills. It
                            opens up a world of employment opportunities leading to economic well-
                            being and better living. </p>
                        <p>At Vidya Chetana, we strive to support higher education of deserving
                            students from socio-economically less-privileged backgrounds.</p>
                        <p class="thm-text">Our Scholarship Programme supports students wanting to pursue</p>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td>₹15,000/student </td>
                                <td>₹25,000/student</td>
                                <td>₹50,000/student </td>
                                <td>₹50,000/student</td>
                            </tr>
                        </table>

                        <p class="thm-text">Help us to keep 750 hopes alive!</p>
                        <p>This year, we received scholarship applications from 1,651 students. So far,
                            we could fund 901 students across various courses. We still have 750
                            students waiting to get scholarships. To fund these hopeful students, we
                            require ₹1,87,50,000. Make a generous donation for education and
                            support academic goals and career aspirations of meritorious students.</p>
            ...
            <div class="col-xl-6 col-lg-6 order-first order-md-2">
                <div class="contact-page__form helping-one__right-form">
                    <form name="donate-form" action="<?php echo base_url(); ?>sponsor-student-for-higher-education" class="contact-page__main-form " id="donate-form" method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="programme" value="sponsor-student-for-higher-education">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="helping-one__right-input-box">
                                    <input class="form-control" type="number" name="amount" placeholder="Other amount*" id="amount" value="2000">
...
<div class="container mt-50">
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="section-title text-center">
                <span class="section-title__tagline">When you sponsor education, the result is always success!</span>
                <!-- <h2 class="section-title__title_small">When you sponsor education, the result is always success!
                </h2> -->
            </div>
        </div>
        <div class="col-md-12">
            <section class="need-help beneficiaries  owl-theme owl-carousel mb-3 ">
                <div class="container ">
                    <div class="need-help__inner">
                        ...
                        <div class="need-help__content need-help_content">
                            <h4 class="need-help__title">Sahana, BTech
                                Graduate, Presidency University, Bengaluru</h4>
                            <p class="need-help__text">“The scholarship I received from Vidya Chetana
                                helped me to complete my final year BTech,
                                following which I also secured a placement in IBM.
                                I am extremely grateful to Vidya Chetana for
                                helping me achieve my goal.”</p>
                ...
                <div class="container">
                    <div class="need-help__inner">
                        ...
                        <div class="need-help__content need-help_content">
                            <h4 class="need-help__title">Yathish K.S., B.E. Mechanical
                                Graduate, RVCE, Bengaluru</h4>
                            <p class="need-help__text">“I could complete my engineering only because of
                                the scholarship I received from Vidya Chetana.
                                After completing my studies, I immediately got a
                                placement in DXA Technology. I am thankful to
                                the team of Vidya Chetana for supporting my
                                education.”</p>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="join-one__inner">
                    <h5 class="join- text-white">“Higher education is essential for a thriving society: it is
                        the strongest, sturdiest ladder to increased socio-
                        economic mobility and the locus, through research
                        universities, of most of the major discoveries of the

                        last two centuries.”</h5>
                    <p class="text-white">– Drew Gilpin Faust, 28 th President of Harvard University</p>
                    <a href="sponsor-student-for-higher-education" class="join-one__btn thm-btn"><i class="fas fa-arrow-circle-right"></i>DONATE TO EDUCATE –</a>
                </div>
            </div>
        </div>
    </div>
