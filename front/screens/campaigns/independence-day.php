...
<section class="feature-one bg-light">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <div class="section-title text-center">
                    <span class="section-title__tagline">Educate. Empower. Progress.</span>
                    ...
                    <p class="mt-20">Having the world’s largest youth population with 356 million young people, India is the most promising country at the moment. And as citizens
of the country, <span class="thm-text">it is our responsibility to turn this community of youth into real assets.</span> Join us to make them self-sufficient and resourceful.</p>
                ...
                <div class="contact-page__left">
                    ...
                    <div class="contact-page__contact-info">
                        <div class="section-title">
                            <span class="section-title__tagline mt-4">Education combined with skills development leads to empowerment </span>
                        </div>
                        <img src="assets/images/campaigns/1.png">
                        <img src="assets/images/campaigns/2_.png">

                       

                        <h4 class="section-title__tagline"> Empowerment results in progress</h4>
                        <img src="assets/images/campaigns/3.png" width="40vw">
                        <img src="assets/images/campaigns/4.png" width="40vw">
                        
                        <h4 class="section-title__tagline">Donate today & ensure inclusive progress through education   </h4>
                        <p>Contributing towards education of meritorious students from challenging socio-economic backgrounds is one of the most tangible ways to get involved in the progress of the nation. </p>
                        <p class="thm-text">This year, we need your support to provide education to 2,500 students, of which 2,415 are our existing beneficiaries and 
85 are new students.
</p>
            ...
            <div class="col-xl-6 col-lg-6 order-first order-md-2">
                <div class="contact-page__form helping-one__right-form">
                    <form name="donate-form" action="<?php echo base_url(); ?>independence-day" class="contact-page__main-form " id="donate-form"  method="post" enctype="multipart/form-data">
                        <h3 class="text-center section-title__tagline">Give freedom to higher education</h3>
                        ...
                        <input type="hidden" name="programme" value="independence-day">
                        ...
                        <div class="row">
                            ...
                            <div class="row" id="indian-hide" style="display:none">
                                ...
                                <div class="col-xl-8">
                                    <div class="contact-page__input-box">
                                        <input  class="form-control" type="text" name="payble_amount" placeholder="" id="payble_amount" value="2000" readonly>
            ...
            <div class="section-title mt-4">
                <span class="section-title__tagline mt-4">Donors speak</span>
            </div>
            <img src="assets/images/campaigns/5.png">
            <img src="assets/images/campaigns/6.png">
...
<section>
    ...
    <div class="row mt-5">
                    ...
                    <div class="section-title ">
                        <span class="section-title__tagline mt-4">Know More About Us</span>
                    </div>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingFour">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                            4. What is the reach of Vidya Chetana?
                                        </button>
                                    </h2>
                                    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                        Currently, Vidya Chetana supports higher education of underprivileged students across 10 locations in India namely Karnataka, Andhra Pradesh, Telangana, Odisha, Madhya Pradesh, Delhi, Tamil Nadu, Jammu & Kashmir, Uttarakhand, and Maharashtra.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
