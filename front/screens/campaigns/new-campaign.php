        ...
        <div class="row mt-4">
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="contact-page__left">
                    <div class="card mt-4 w-100 box-percentage p-4">
                    <h3 class="text-center section-title__tagline mb-4">Total fund raised till today</h3>
                            <?php $amount_sum = $this->db->select('SUM(amount) as amount')->where('programme','new-campaign')->where('payment_status','success')->get('payments')->row();  
            ...
            <div class="col-xl-6 col-lg-6 order-first order-md-2">
                ...
                <div class="contact-page__form helping-one__right-form">
                    <form name="donate-form" action="<?php echo base_url(); ?>new-campaign" class="contact-page__main-form " id="donate-form" method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="programme" value="new-campaign">
